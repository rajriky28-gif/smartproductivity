...
const steps = [
  {
    ...
    title: "Observe",
    description:
      "We study how people actually work, not how apps assume they do.",
  },
  {
    step: "02",
    title: "Simplify",
    description: "We remove friction, features, and unnecessary choices.",
  },
  {
    step: "03",
    title: "Design for Humans",
    description: "Every decision respects cognitive load and attention.",
  },
  {
    step: "04",
    title: "Refine Slowly",
    description: "We improve deliberately, not obsessively.",
  },
];
